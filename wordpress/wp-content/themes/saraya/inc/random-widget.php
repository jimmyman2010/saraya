...
class Testimonials_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __( 'Testimonials', 'dickinsons' ), // Name
            array( 'description' => __( 'Show the random testimonials', 'dickinsons' ), ) // Args
        );
    }
    ...
    public function form( $instance ) {
        $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Testimonials', 'dickinsons' );
        ?>
        <p>
